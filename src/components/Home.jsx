...
function Home() {
  ...
  return (
    <div className="h-screen w-screen flex">
      <Navbar />
      <div className="w-[85%] h-[100vh] flex flex-wrap gap-5 py-20 px-10">
        {products.map((product,i) => (
          <Link
            to="/detail/1"
            className="card h-72 w-56 border shadow mr-4 px-10 py-5 flex items-center flex-col gap-5 rounded-md"
            key={i}
          >
            <div
